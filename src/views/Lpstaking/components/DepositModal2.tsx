...
import { Button, IconButton, AddIcon, LinkExternal } from '@pancakeswap/uikit'
...
export const DepositModal2: React.FC<DepositModalProps> = ({ max, onConfirm, tokenName = '', addLiquidityUrl }) => {
  ...
  return (
    <div>
      <IconButton variant="tertiary" onClick={openModal}>
